        ...
        <div>
            ...
            <section className="terms-section-container">
                ...
                <p className="text-lg mb-6">
                    Welcome to Spinn Creative. By accessing or using our
                ...
                <p className="text-lg mb-6">
                    The content provided on this site is for general information
                    purposes only. We reserve the right to modify or discontinue
                ...
                <p className="text-lg mb-6">
                    ...
                    and images, is the property of Spinn Creative and is
                ...
                <p className="text-lg mb-6">
                    Spinn Creative will not be liable for any damages arising
                    out of the use or inability to use the site, including but
