...
export default function Graphics(): JSX.Element {
    ...
    const services = [
        {
            title: 'Our Graphics Services Include:',
        ...
        <div>
            ...
            <section className="graphics-design-hero flex items-center justify-center text-center">
                <div className="graphics-design-hero-overlay">
                    <h1 className="text-6xl font-bold text-white">Graphics</h1>
                </div>
            </section>

            {/* Graphic Design Services Section */}
            <section className="graphics-design-section-container">
                <h2 className="text-4xl font-bold mb-4">Graphics Services</h2>
                <p className="text-lg mb-6">
                    At Spinn Creative, we believe that every design tells a
                    story. Our graphics services are all about creating visuals
                    that not only look stunning but also communicate your
                    brand’s essence and values. Whether you need eye-catching
                    marketing materials, a sleek website design, or a full brand
                    identity, our team has the creativity and expertise to
                    deliver designs that resonate with your audience.
                </p>
            </section>
                    ...
                    <div className="embla overflow-hidden" ref={emblaRef}>
                        <div className="embla__container flex transition-transform duration-[700ms] ease-in-out">
                            {services.map((service, index) => (
                                ...
                                >
                                    <div
                                        className={`flex flex-col md:flex-row items-stretch ${index % 2 === 0 ? 'md:flex-row-reverse' : 'md:flex-row'}`}
                                    >
                                        <div className="flex-1 bg-gray-900 text-white flex items-center justify-center p-8">
                                            <div>
                                                ...
                                                <p className="mt-4 whitespace-pre-line text-lg md:text-xl">
                                                    {service.description}
                                                </p>
                                            </div>
                                        </div>
